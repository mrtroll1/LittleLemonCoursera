...
SECRET_KEY = "django-insecure-sc0e*&c5sx013^_*(dvj@n4e&cwmi1w=)e4agubh9r^%^=3m=("
...
REST_FRAMEWORK = {
    'DEFAULT_RENDERER_CLASSES': [
        ...
        'rest_framework.renderers.BrowsableAPIRenderer', # comment this line to see raw JSON responses
